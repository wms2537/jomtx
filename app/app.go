...
type App struct {
	*baseapp.BaseApp
	...
	JomtxKeeper jomtxmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.JomtxKeeper = *jomtxmodulekeeper.NewKeeper(
		appCodec,
		keys[jomtxmoduletypes.StoreKey],
		keys[jomtxmoduletypes.MemStoreKey],
		app.GetSubspace(jomtxmoduletypes.ModuleName),
	)
	jomtxModule := jomtxmodule.NewAppModule(appCodec, app.JomtxKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(jomtxmoduletypes.ModuleName)
